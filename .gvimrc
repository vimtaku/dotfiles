...
if has('win32')
  ...
  " フォント
  "set guifont=M+1VM+IPAG circle:h10,Lucida_Console:h10:w5 guifontwide=MS_Gothic:h10
  set guifont=M+2VM+IPAG_circle:h10.5:cSHIFTJIS
...
" 日本語のときキャレットがpurpleに
hi CursorIM  guifg=black  guibg=purple  gui=NONE  ctermfg=black  ctermbg=white  cterm=reverse
